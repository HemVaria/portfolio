...
export default function Projects() {
  ...
  return (
    <section id="projects" className="bg-black py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-6 md:px-12">
        {/* Section Header */}
        <div className="mb-20">
          <motion.h2
            className="text-[clamp(2.5rem,8vw,5rem)] font-bold text-white uppercase tracking-tight"
          ...
          <motion.p 
            className="text-white/50 max-w-xl mt-4 text-lg"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                  ...
                  <div className="flex items-baseline gap-4 md:gap-8">
                    ...
                    <div className="relative">
                      <span className="text-[clamp(6rem,20vw,14rem)] font-bold leading-none text-transparent [-webkit-text-stroke:1px_rgba(255,255,255,0.3)] select-none">
                        {String(i + 1).padStart(2, "0").charAt(0)}
                      </span>
                      <span className="text-[clamp(6rem,20vw,14rem)] font-bold leading-none text-[#9A9A9A]/30 select-none ml-[-0.1em]">
                  ...
                  <div className="relative">
                    ...
                    <div className="flex flex-col gap-3">
                      <div className="flex items-start justify-between gap-4">
                        <div>
                          <p className="text-xs md:text-sm font-mono text-white/40 mb-2 tracking-wider">
                            {project.category}
                          </p>
                          <h3 className="text-xl md:text-2xl font-bold text-[#D4C5A9] font-mono group-hover:text-white transition-colors duration-300">
                            {project.title}
                          </h3>
                        </div>
                        ...
                        <div className="flex items-center gap-2 shrink-0 flex-wrap justify-end">
                          {project.repo && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center gap-1.5 px-3 py-1 text-xs border border-white/20 rounded-full text-white/60 hover:bg-white hover:text-black transition-colors"
